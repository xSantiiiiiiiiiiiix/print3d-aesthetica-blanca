        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="w-full lg:w-1/2 opacity-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="grid grid-cols-2 gap-4">
              <div className={cn(
                "aspect-square overflow-hidden rounded-2xl shadow-soft",
                "translate-y-8"
              )}>
                <img
          ...
          <div className="w-full lg:w-1/2 opacity-0 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            ...
            <p className="text-muted-foreground mb-8">
              Fundada en 2020, Aesthetica 3D nació de la pasión por la innovación y el diseño. Desde entonces, hemos ayudado a cientos de clientes a materializar sus ideas, desde prototipos industriales hasta objetos decorativos únicos.
            </p>
